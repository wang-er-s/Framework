...
{
    [CustomEditor(typeof(CustomTextMesh3D), true), CanEditMultipleObjects]
    public class CustomTMP3DEditor : TMP_EditorPanel
    {
        ...
        private CustomTextMesh3D textMeshPro;
        ...
        [MenuItem("GameObject/3D Object/Custom Text-TMP", false, -9)]
        private static void CreateTextTMP(MenuCommand menuCommand)
        {
            var method = typeof(TMPro_CreateObjectMenu).GetMethod("CreateTextMeshProObjectPerform",
        ...
        {
            textMeshPro = target as CustomTextMesh3D;
            base.OnEnable();
