...
{
    // 加载spriteAtlas
    public class SpriteAtlasLoader : AbstractResourceLoader
    {
        ...
        public static SpriteAtlasLoader Load(string path, string spriteName, CKSpriteAtlasLoaderDelegate callback = null)
        {
            ...
            return AutoNew<SpriteAtlasLoader>(path, newCallback);
        }
