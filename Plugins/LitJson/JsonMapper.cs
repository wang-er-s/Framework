...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        private static Type jsonIgnoreType = typeof(LitJsonIgnore);
        ...
        private static void AddTypeProperties (Type type)
        {
            ...
            foreach (PropertyInfo p_info in type.GetProperties (BindingFlags.Instance | BindingFlags.Public)) {
                if(p_info.GetCustomAttribute(jsonIgnoreType) != null) continue;
                PropertyMetadata p_data = new PropertyMetadata ();
                p_data.Info = p_info;
            ...
            foreach (FieldInfo f_info in type.GetFields (BindingFlags.Instance| BindingFlags.Public)) {
                if(f_info.GetCustomAttribute(jsonIgnoreType) != null) continue;
                PropertyMetadata p_data = new PropertyMetadata ();
                p_data.Info = f_info;
                p_data.IsField = true;
                                        ...
                                        int depth)
        {
            ...
            if (obj is IDictionary dictionary) {
                ...
                {
                    var propertyName = entry.Key is string key ? key
