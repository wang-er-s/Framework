...
namespace AD.UI.Core
{
    ...
    public class BindFunc<TComponent> : IInitBind where TComponent : Component
    {
    ...
    public class BindFuncWithPara<TComponent, TData> : IInitBind where TComponent : Component
    {
        private TComponent component;
