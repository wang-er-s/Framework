...
namespace AD
{
    public static class BuildScript
    {
        ...
        public static void CopyAssetBundlesTo(string outputPath)
        {
            ...
            var source = ResPath.EditorAssetBundleFullPath;
        ...
        {
            var relativeAssetBundlesOutputPathForPlatform = ResPath.EditorAssetBundleFullPath;
        ...
        public static string CreateAssetBundleDirectory()
        {
            ...
            var outputPath = ResPath.EditorAssetBundleFullPath;
            if (!Directory.Exists(outputPath))
                Directory.CreateDirectory(outputPath);
        ...
        {
            return GetAsset<Settings>(Configs.AssetsSettingPath);
        }

        public static AssetsManifest GetManifest()
        {
            return GetAsset<AssetsManifest>(Configs.AssetsManifestPath);
        }
