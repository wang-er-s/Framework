...
namespace AD
{
    ...
    public class AssetBundleLoader : AbstractResourceLoader
    {
        ...
        private AssetBundleParser BundleParser;
        ...
        static void PreLoadManifest()
        {
            ...
            Debugger.Assert(_mainAssetBundle);
            Debugger.Assert(_assetBundleManifest);
        }
#endif
        ...
        protected override void Init(string url, params object[] args)
        {
            ...
            ResourceModule.LogRequest("AssetBundle", RelativeResourceUrl);
            ResourceModule.Ins.StartCoroutine(LoadAssetBundle(url));
        }
        ...
        private IEnumerator LoadAssetBundle(string relativeUrl)
        {
...
#endif
            var bytesLoader = HotBytesLoader.Load(ResPath.BundlesPathRelative + relativeUrl, _loaderMode);
            ...
            if (!bytesLoader.IsSuccess)
            {
                ...
                Debugger.Error("[AssetBundleLoader]Error Load Bytes AssetBundle: {0}", relativeUrl);
                OnFinish(null);
                yield break;
            }
            ...
            BundleParser = new AssetBundleParser(RelativeResourceUrl, bundleBytes);
            ...
            if (assetBundle == null)
                Debugger.Error("WWW.assetBundle is NULL: {0}", RelativeResourceUrl);
        ...
        public override void Release()
        {
            if (Application.isEditor)
            {
                ...
                {
                    Debugger.Error("要释放Arial字体！！错啦！！builtinextra:{0}", Url);
