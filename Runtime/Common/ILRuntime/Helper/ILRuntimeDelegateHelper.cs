...
namespace Framework
{
    public class ILRuntimeDelegateHelper
    {
        ...
        public static void RegisterDelegate(ILRuntime.Runtime.Enviorment.AppDomain appdomain)
        {
            ...
            appdomain.DelegateManager.RegisterDelegateConvertor<System.Action<Framework.MonoBehaviourAdapter.Adaptor>>((act) =>
            {
                return new System.Action<Framework.MonoBehaviourAdapter.Adaptor>((obj) =>
                {
                    ((Action<Framework.MonoBehaviourAdapter.Adaptor>)act)(obj);
                });
            });
