    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        */
        public void InitListView(int itemTotalCount,
            System.Func<LoopListView2, int, LoopListViewItem2> onGetItemByIndex, Func<LoopListViewItem2> createFunc, string prefabName,
            LoopListViewInitParam initParam = null)
        {
            ...
            InitItemPool(createFunc, prefabName);
        ...
        */
        ...
        public LoopListViewItem2 NewListViewItem(string itemPrefabName)
        {
            ...
            RectTransform rf = item.GameObject.GetComponent<RectTransform>();
        ...
        */
        ...
        void InitItemPool(Func<LoopListViewItem2> createFunc, string prefabName)
        {
            foreach (ItemPrefabConfData data in mItemPrefabDataList)
            {
                if (data.mItemPrefab == null)
                ...
                pool.Init(createFunc, prefabName, data.mPadding,data.mStartPosOffset, data.mInitCreateCount, mContainerTrans);
