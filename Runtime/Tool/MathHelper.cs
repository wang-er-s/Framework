...
namespace Framework
{
	public static class MathHelper
	{
		...
		public static RecyclableList<Vector3> GetLineBezierList(Vector3 startPoint, Vector3 endPoint, int segmentNum = 10)
		{
			RecyclableList<Vector3> path = RecyclableList<Vector3>.Create(segmentNum);
			path.Add(startPoint);
