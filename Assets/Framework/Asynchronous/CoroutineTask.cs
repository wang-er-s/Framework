...
namespace Framework.Asynchronous
{
    ...
    public class CoroutineTask
    {
        ...
        public Exception Exception => _asyncResult.Exception;

        public bool IsCompleted => _asyncResult.IsDone && _asyncResult.Exception == null;

        public bool IsCancelled => _asyncResult.IsDone && _asyncResult.IsCancelled;

        public bool IsFaulted => _asyncResult.IsDone && !_asyncResult.IsCancelled && _asyncResult.Exception != null;

        public bool IsDone => _asyncResult.IsDone;

        internal protected CoroutineTask(AsyncResult asyncResult)
        {
        ...
        public CoroutineTask(IEnumerator routine) : this(new AsyncResult(true))
        {
            try
            {
                ...
                Executors.RunOnCoroutine(routine, this._asyncResult);
            }
            catch (Exception e)
            {
        ...
        {
            return this._asyncResult.WaitForDone();
        }

        public virtual IAwaiter GetAwaiter()
        {
            return new AsyncResultAwaiter<AsyncResult>(_asyncResult);
        }
        ...
        protected bool IsExecutable(IAsyncResult ar, CoroutineTaskContinuationOptions continuationOptions)
        {
            ...
            if (!executable)
                executable = (ar.IsCancelled &&
                              (continuationOptions & CoroutineTaskContinuationOptions.OnCanceled) > 0);
            if (!executable)
    ...
    {
        private readonly AsyncResult<TResult> _asyncResult;

        public TResult Result => _asyncResult.Result;
        ...
        {
            return new AsyncResultAwaiter<AsyncResult<TResult>, TResult>(this._asyncResult);
        }
    }
}
