...
namespace Framework.Asynchronous
{
    public static class CoroutineAwaiterExtensions
    {
        ...
        {
            return new AsyncOperationAwaiter<AssetBundleCreateRequest, AssetBundle>(target,
                (request) => request.assetBundle);
        }

        public static IAwaiter<UnityWebRequest> GetAwaiter(this UnityWebRequestAsyncOperation target)
        {
            return new AsyncOperationAwaiter<UnityWebRequestAsyncOperation, UnityWebRequest>(target,
