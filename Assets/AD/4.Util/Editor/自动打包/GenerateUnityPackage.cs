...
namespace AD
{
	...
	{
        [MenuItem("Assets/AD/导出UnityPackage %-Ctrl+e")]
        private static void Create()
        {
            string packageName = "AD" + DateTime.Now.ToString("yyyyMMddhhtt");
            ...
            if (assetPathNames.Length <= 0) assetPathNames = new string[] { "Assets/AD" };
