...
namespace Nine
{
	...
	{
        [MenuItem("Assets/Nine/导出UnityPackage %-Ctrl+e")]
        private static void Create()
        {
            string packageName = "Nine" + DateTime.Now.ToString("yyyyMMddhhtt");
            ...
            if (assetPathNames.Length <= 0) assetPathNames = new string[] { "Assets/Nine" };
